...
ALTER TABLE SERVER_ALERTS ADD INDEX(ALERT_ID);
ALTER TABLE SERVER_ALERTS ADD INDEX(SERVER_TYPE);

ALTER TABLE SERVER_ALERTS ADD FULLTEXT (SERVER_ID, DESCRIPTION_ALERT, ALERT_ID, SERVER_TYPE);
